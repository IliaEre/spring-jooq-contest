...
public class Product extends TableImpl<ProductRecord> {
    ...
    private static final long serialVersionUID = 98946542;
     ...
     */
    public final TableField<ProductRecord, String> VENDOR = createField(DSL.name("vendor"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.product.sn</code>.
     */
    public final TableField<ProductRecord, String> SN = createField(DSL.name("sn"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.product.owner</code>.
     */
    public final TableField<ProductRecord, String> OWNER = createField(DSL.name("owner"), org.jooq.impl.SQLDataType.CLOB, this, "");
